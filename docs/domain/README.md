...
ultima-revisao: TASK-014, 2026-09-13
---
...
- `wear` é **opcional por definição**, não por estar incompleto: só peças cujo desgaste tem leitura visual didática o preenchem (5 das 34 hoje). Consumidores precisam tratar a ausência como caso normal, nunca como dado faltando.
- Todo `wear` precisa dos três campos, e o `note` é obrigatório justamente porque é ele que impede a comparação de virar diagnóstico — nunca preencha `normal`/`worn` sem ele.
